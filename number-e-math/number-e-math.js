// Number
// É uma construtora de números, todo número possui as propriedades e métodos do prototype de Number. Number também possui alguns métodos
const ano = 2020;
const preco = new Number(99);


// Number.isNaN() e Number.isInteger()
// isNaN() é um método de Number, ou seja, não faz parte do protótipo. isInteger() verifica se é uma integral (numero inteiro)
...
parseInt(5.4343566555, 10); // 5
Number.parseInt('100 reais', 10); // 100
// float possuí decimal, integer não.
